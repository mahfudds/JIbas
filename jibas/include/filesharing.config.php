...
/* Batasan maksimal ukuran file yang bisa di upload */
$FILESHARE_UPLOAD_MAXSIZE = 20; // MB

/* Batasan maksimal total file untuk setiap pengguna */
$FILESHARE_USER_TOTALSIZE = 100; // MB
?>