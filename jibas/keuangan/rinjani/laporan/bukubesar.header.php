...
<head>
    ...
    <script language="javascript" src="bukubesar.header.js?r=<?=filemtime('bukubesar.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php           if ($dataTahunBuku64 != "")
        ...
        <tr>
            <td><b>Kategori</b></td>
            <td>
<?php           ShowSelectKategoriAkunLaporan($db) ?>
            </td>
        </tr>
        </table>
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Laporan Buku Besar</span><br>
        <a class="pageLink" href="laporan.php"><b>Laporan Keuangan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Laporan Buku Besar</td>
    </td>
</tr>
</table>
