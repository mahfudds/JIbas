...
function ShowLaporanAuditTabunganPegawai($db)
{
    global $nRowPerPage;
    ...
    while ($row = mysqli_fetch_array($result))
    {
        ...
        echo "<td align='right'><b>" . FormatRupiah($row['debet']) . "</b></td>";
        echo "<td align='right'><b>" . FormatRupiah($row['kredit']) . "</b></td>";
