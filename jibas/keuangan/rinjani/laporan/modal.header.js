...
async function showLaporan()
{
    ...
    parent.content.location.href = "modal.content.php?" + qsb.createQs();
}
...
function showHelp()
{
    newWindow('../help/lap_perubahan.html', 'LapPerubahanModalHelp','620','520','resizable=1,scrollbars=1,status=0,toolbar=0')
}