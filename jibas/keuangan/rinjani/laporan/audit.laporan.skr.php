...
require_once('audit.laporan.skr.func.php');
...
$jenisLaporan = "Perubahan Data Iuran Sukarela Siswa";
if ($lap == "penerimaaniurancalon")
    $jenisLaporan = "Perubahan Data Iuran Sukarela Calon Siswa";
?>
...
<head>
    ...
    <script language="javascript" src="audit.laporan.skr.js?r=<?=filemtime('audit.laporan.skr.js')?>"></script>
</head>
<body>
