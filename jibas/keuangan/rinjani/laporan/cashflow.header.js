...
async function showLaporan()
{
    ...
    parent.content.location.href = "cashflow.content.php?" + qsb.createQs();
}
...
function showHelp()
{
    newWindow('../help/lp_aruskas.html', 'LaporanArusKasHelp','620','520','resizable=1,scrollbars=1,status=0,toolbar=0')
}