...
function onChangePage()
{
    ...
    $.ajax({
        url: "audit.laporan.jurnalumum.ajax.php",
        method: "POST",
        data: qsb.createQs(),
...
function cetak()
{
    ...
    newWindow('audit.laporan.jurnalumum.cetak.php?'+qsb.createQs(), 'CetakAuditJurnalUmum','790','630','resizable=1,scrollbars=1,status=0,toolbar=0'		)
}
