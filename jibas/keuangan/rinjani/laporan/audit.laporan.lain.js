...
function onChangePage()
{
    ...
    $.ajax({
        url: "audit.laporan.lain.ajax.php",
        method: "POST",
        data: qsb.createQs(),
...
function cetak()
{
    ...
    newWindow('audit.laporan.lain.cetak.php?'+qsb.createQs(), 'CetakAuditPenerimaanLain','790','630','resizable=1,scrollbars=1,status=0,toolbar=0'		)
}
