...
async function showLaporan()
{
    ...
    parent.content.location.href = "neraca.content.php?" + qsb.createQs();
}
...
function showHelp()
{
    newWindow('../help/lp_neraca.html', 'LaporanNeracaHelp','620','520','resizable=1,scrollbars=1,status=0,toolbar=0')
}