...
<head>
    ...
    <script language="javascript" src="neraca.header.js?r=<?=filemtime('neraca.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php       if ($dataTahunBuku64 != "")
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Laporan Neraca</span><br>
        <a class="pageLink" href="laporan.php"><b>Laporan Keuangan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Laporan Neraca</td>
    </td>
</tr>
</table>
