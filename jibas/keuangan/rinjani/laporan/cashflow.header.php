...
<head>
    ...
    <script language="javascript" src="cashflow.header.js?r=<?=filemtime('cashflow.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php       if ($dataTahunBuku64 != "")
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Laporan Arus Kas</span><br>
        <a class="pageLink" href="laporan.php"><b>Laporan Keuangan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Laporan Arus Kas</td>
    </td>
</tr>
</table>
