...
<head>
    ...
    <script language="javascript" src="modal.header.js?r=<?=filemtime('modal.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php           if ($dataTahunBuku64 != "")
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Laporan Perubahan Modal</span><br>
        <a class="pageLink" href="laporan.php"><b>Laporan Keuangan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Laporan Perubahan Modal</td>
    </td>
</tr>
</table>
