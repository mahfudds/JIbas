...
require_once('audit.laporan.jurnalumum.func.php');
...
$jenisLaporan = "Perubahan Data Jurnal Umum";
?>
...
<head>
    ...
    <script language="javascript" src="audit.laporan.jurnalumum.js?r=<?=filemtime('audit.laporan.jurnalumum.js')?>"></script>
</head>
<body>
