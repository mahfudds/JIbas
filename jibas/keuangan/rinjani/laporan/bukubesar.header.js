...
async function showLaporan()
{
    ...
    parent.content.location.href = "bukubesar.content.php";

    await pause(200);

    parent.content.pilih.location.href = "bukubesar.rekap.php?" + qsb.createQs();
...
function showHelp()
{
    newWindow('../help/lp_bukubesar.html', 'LaporanBukuBesarHelp','620','520','resizable=1,scrollbars=1,status=0,toolbar=0')
}
