...
require_once('audit.laporan.tabunganp.func.php');
...
$jenisLaporan = "Perubahan Data Tabungan Pegawai";
?>
...
<head>
    ...
    <script language="javascript" src="audit.laporan.tabunganp.js?r=<?=filemtime('audit.laporan.tabunganp.js')?>"></script>
</head>
<body>
...
<div id="dvDaftarAudit">
    <?php
    ShowLaporanAuditTabunganPegawai($db);
    ?>
</div>
