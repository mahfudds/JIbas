...
<head>
    ...
    <script language="javascript" src="audit.header.js?r=<?=filemtime('audit.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php       /*
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Audit Perubahan Data</span><br>
        <a class="pageLink" href="laporan.php"><b>Laporan Keuangan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Audit Perubahan Data</td>
    </td>
</tr>
</table>
