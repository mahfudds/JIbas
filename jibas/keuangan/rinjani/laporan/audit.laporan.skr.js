...
function onChangePage()
{
    ...
    $.ajax({
        url: "audit.laporan.skr.ajax.php",
        method: "POST",
        data: qsb.createQs(),
...
function cetak()
{
    ...
    newWindow('audit.laporan.skr.cetak.php?'+qsb.createQs(), 'CetakAuditSukarela','790','630','resizable=1,scrollbars=1,status=0,toolbar=0'		)
}
