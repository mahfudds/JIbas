...
<head>
    ...
    <script language="javascript" src="neracaper.header.js?r=<?=filemtime('neracaper.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php       if ($dataTahunBuku64 != "")
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Laporan Neraca Percobaan</span><br>
        <a class="pageLink" href="laporan.php"><b>Laporan Keuangan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Laporan Neraca Percobaan</td>
    </td>
</tr>
</table>
