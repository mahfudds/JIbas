...
$jenisLaporan = "Perubahan Besar Iuran Wajib Siswa";
if ($lap == "besarjttcalon")
    $jenisLaporan = "Perubahan Besar Iuran Wajib Calon Siswa";
?>
...
<head>
    ...
    <script language="javascript" src="audit.laporan.besarjtt.js?r=<?=filemtime('audit.laporan.besarjtt.js')?>"></script>
</head>
<body>
