...
function onChangePage()
{
    ...
    $.ajax({
        url: "audit.laporan.pengeluaran.ajax.php",
        method: "POST",
        data: qsb.createQs(),
...
function cetak()
{
    ...
    newWindow('audit.laporan.pengeluaran.cetak.php?'+qsb.createQs(), 'CetakAuditPengeluaran','790','630','resizable=1,scrollbars=1,status=0,toolbar=0'		)
}
