...
require_once('audit.laporan.pengeluaran.func.php');
...
$jenisLaporan = "Perubahan Data Pengeluaran";
?>
...
<head>
    ...
    <script language="javascript" src="audit.laporan.pengeluaran.js?r=<?=filemtime('audit.laporan.pengeluaran.js')?>"></script>
</head>
<body>
...
<div id="dvDaftarAudit">
    <?php
    ShowLaporanAuditPengeluaran($db);
    ?>
</div>
