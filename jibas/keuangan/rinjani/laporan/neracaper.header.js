...
async function showLaporan()
{
    ...
    parent.content.location.href = "neracaper.content.php?" + qsb.createQs();
}
...
function showHelp()
{
    newWindow('../help/lp_neracaper.html', 'LaporanNeracaPercobaanHelp','620','520','resizable=1,scrollbars=1,status=0,toolbar=0')
}