...
function ShowLaporanAuditSukarela($db)
{
    global $nRowPerPage;
    global $idTahunBuku, $departemen, $lap, $tanggal1, $tanggal2, $page;

    $auditTable = "jbsfina.auditpenerimaaniuran";
    if ($lap == "penerimaaniurancalon")
        $auditTable = "jbsfina.auditpenerimaaniurancalon";
    ...
    $sql = "SELECT DISTINCT ai.petugas as petugasubah, j.transaksi, date_format(ai.tanggal, '%d-%b-%Y %H:%i:%s') as tanggalubah, 
              ...
              FROM $auditTable ap, auditinfo ai, jurnal j 
