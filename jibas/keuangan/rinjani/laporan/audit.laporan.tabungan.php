...
require_once('audit.laporan.tabungan.func.php');
...
$jenisLaporan = "Perubahan Data Tabungan Siswa";
?>
...
<head>
    ...
    <script language="javascript" src="audit.laporan.tabungan.js?r=<?=filemtime('audit.laporan.tabungan.js')?>"></script>
</head>
<body>
...
<div id="dvDaftarAudit">
    <?php
    ShowLaporanAuditTabunganSiswa($db);
    ?>
</div>
