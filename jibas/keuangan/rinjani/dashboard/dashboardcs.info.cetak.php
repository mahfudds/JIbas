...
<head>
    ...
    <script type="application/javascript">
        ...
        {
            var content = "";
            if (window.opener && typeof window.opener.getPageContentInfoCalonSiswa === "function")
            {
                content = window.opener.getPageContentInfoCalonSiswa("content");
            }
...
<?=     getHeader2($db, $departemen) ?>
        ...
        <center><font size="4"><strong>Informasi Calon Siswa</strong></font><br /> </center><br>
