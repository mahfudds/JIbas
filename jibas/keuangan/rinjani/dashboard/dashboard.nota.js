...
function tambahNotaSiswa() 
{
    ...
    newWindow('dashboard.nota.dialog.php?'+qsb.createQs(), 'TambahNotaSiswa','520','520','resizable=1,scrollbars=1,status=0,toolbar=0');
}
...
function edit(idNota)
{
    ...
    newWindow('dashboard.nota.dialog.php?'+qsb.createQs(), 'UbahNotaSiswa','520','520','resizable=1,scrollbars=1,status=0,toolbar=0');
}
