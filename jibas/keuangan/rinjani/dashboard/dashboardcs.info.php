...
$sql = "SELECT c.nopendaftaran, c.nama, c.panggilan, c.tahunmasuk, c.idkelompok, c.suku, c.agama, c.status, c.kondisi, c.kelamin,
			   ...
			   c.alamatortu, c.telponortu, c.hportu, c.info1, c.info2, c.emailayah, c.emailibu, c.alamatsurat, c.keterangan, 
               p.departemen, k.kelompok, p.proses, c.nisn, c.nik,c.noun,c.statusanak,c.jkandung,c.jtiri,c.jarak,
		 ...
		 WHERE c.replid = $idCalon 
           AND k.replid = c.idkelompok 
           AND k.idproses = p.replid";
$res = $db->QueryDb($sql);
$row = mysqli_fetch_array($res);
?>
<div id='dvInfoCalonSiswa' style="padding: 10px; width: 780px;">
...
<tr>
    <th align="left" scope="row"><strong>Proses</strong></th>
    <td align="left"><strong>:&nbsp;
            <?=$row['proses']?>
        </strong>
    </td>
...
<tr>
    <th align="left" scope="row"><strong>Kelompok</strong></th>
    <td align="left"><strong>:&nbsp;
            <?=$row['kelompok']?>
        </strong>
    </td>
...
<tr>
    ...
    <td><strong>:&nbsp;
        <?=$row['nopendaftaran']?></strong>
    </td>
    <td width="50%" rowspan="2" align="right" valign="bottom">
        <span style='margin-left: 30px;' class='cur-hand hide-in-report' onclick='cetakInfoCalonSiswa()'>
...
<table border="0" cellpadding="0" style="border-collapse:collapse" cellspacing="0" width="100%" id="table">
<tr height="30">
    <td colspan="5" align="left" bgcolor="#FFFFFF"><font size="3" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="3" face="Verdana, Arial, Helvetica, sans-serif" color="Gray"><strong>Data Pribadi</strong></font>
...
<tr height="20">
    <td width="5%">2.</td>
    <td colspan="2">Nama Calon Siswa</td>
