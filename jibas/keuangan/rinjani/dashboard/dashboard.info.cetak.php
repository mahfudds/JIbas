...
<head>
    ...
    <script type="application/javascript">
        ...
        {
            var content = "";
            if (window.opener && typeof window.opener.getPageContentInfoSiswa === "function")
            {
                content = window.opener.getPageContentInfoSiswa("content");
            }
...
<?=     getHeader2($db, $departemen) ?>
        ...
        <center><font size="4"><strong>Informasi Siswa</strong></font><br /> </center><br>
