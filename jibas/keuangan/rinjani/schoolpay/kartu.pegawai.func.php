...
function ChangeKartuAktif()
{
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "kqp4e");
    }
    finally
    {
        $db->Close();
...
function ShowKartuPegawai($showMenu)
{
    ...
    try
    {
        ...
        if ($showMenu)
        {
            echo "<table id='table' border='0' cellpadding='0' cellspacing='0' width='830' align='center'>";
        ...
        echo "<table id='table' border='1' class='tab' cellpadding='5' cellspacing='0' style='border-width: 1px;' align='center'>";
        ...
        echo "<td align='center' class='header' width='180'>Payment ID</td>";
        echo "<td align='center' class='header' width='180'>Tanggal Buat</td>";
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "k11g2");
    }
    finally
    {
        $db->Close();
