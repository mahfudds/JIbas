...
<head>
    ...
    <title>Penerimaan Vendor Yang Belum Di Refund</title>
...
?>
    <br>
    <table border="1" id="table" class="tab" style="border-width: 1px; border-collapse: collapse;" cellpadding="2" cellspacing="0">
