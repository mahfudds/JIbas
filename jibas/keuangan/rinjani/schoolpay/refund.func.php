...
function ShowCbVendor($db)
{
    ...
    echo "<select id='vendor' name='vendor' onchange='changeVendor()' class='inputbox' style='width: 250px'>";
...
function ShowCbDepartemen($db)
{
    ...
    echo "<select id='departemen' name='departemen' onchange='changeDepartemen()' class='inputbox' style='width: 250px'>";
    while($row = mysqli_fetch_row($res))
    {
...
function ShowTahunBuku($db, $dept)
{
    ...
    if ($row = mysqli_fetch_row($res))
    {
        ...
        echo "<input type='text' readonly id='tahunbuku' name='tahunbuku' value='$row[1]' class='inputbox' style='background-color: #ededed; width: 120px;'>";
    }
    else
    {
        $selIdTahunBuku = 0;
        ...
        echo "<input type='text' readonly id='tahunbuku' name='tahunbuku' value='belum ada tahun buku' class='inputbox' style='background-color: #ededed; width: 120px;'>";
    }
}

function ShowLastRefundDate($db, $vendorId, $idTahunBuku)
{
...
function ShowTagihanVendor($db, $vendorId, $dept)
{
    $deptPeg = "---";
    $sql = "SELECT departemen
...
function ShowRefundHistory($db, $showMenu)
{
    ...
    if ($showMenu)
    {
        $sb->AppendLine("<table id='table' border='0' cellspacing='0' cellpadding='5' width='95%'  align='center'>");
        $sb->AppendLine("<tr><td align='right'>");
    ...
    $sb->AppendLine("<table id='table' border='1' cellspacing='0' cellpadding='5' class='tab' style='border-width: 1px; border-collapse: collapse' align='center'>");
