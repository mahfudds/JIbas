...
<head>
    ...
    <script language="javascript" src="laporancari.header.js?r=<?=filemtime('laporancari.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php           $departemen = RequestData("departemen", "");
            ShowSelectDepartemenPengeluaran($db) ?>
            &nbsp;&nbsp;
            <strong>Tahun Buku:</strong>
                <span id="dvTahunBuku">
<?php           ShowSelectTahunBukuPengeluaran($db) ?>
                </span>
            </td>
            <td rowspan="3" style="width: 120px" align="center">
        ...
        <tr>
            <td><b>Tanggal</b></td>
            <td>
<?php           echo "<input type='text' id='ftanggal1' onclick='showPilihTanggal(1, \"$dt1\")' readonly size='15' value='$fdt1' class='inputbox' style='background-color:#ddd; width: 150px;'>&nbsp;";
        ...
        <tr>
            <td><b>Pencarian</b></td>
            <td>
                <select id="kriteria" class="inputbox" style="width: 150px" onchange="onChangeSel()">
                    <option value='1'>Nama Pemohon </option>
                    <option value='2'>Nama Penerima </option>
                    <option value='3'>Nama Petugas </option>
                    <option value='4'>Keperluan </option>
                    <option value='5'>Keterangan </option>
                </select>
                <input type="text" id="keyword" size="40" class="inputbox" maxlength="30"/>
            </td>
        </tr>
        </table>
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Cari Pengeluaran</span><br>
        <a class="pageLink" href="pengeluaran.php" target="_parent"><b>Pengeluaran</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Cari Pengeluaran</td>
    </td>
</tr>
</table>
