...
$sql = "SELECT DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 7 DAY), '%Y-%m-%d'),
...
<head>
    ...
    <script language="javascript" src="jurnalpengeluaran2.header.js?r=<?=filemtime('jurnalpengeluaran2.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php       echo "<input type='text' id='ftanggal1' onclick='showPilihTanggal(1, \"$dt1\")' readonly size='15' value='$fdt1' class='inputbox' style='background-color:#ddd; width: 150px;'>&nbsp;";
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Jurnal Pengeluaran</span><br>
        <a class="pageLink" href="pengeluaran.php" target="_parent"><b>Pengeluaran</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Jurnal Pengeluaran</td>
    </td>
</tr>
</table>
