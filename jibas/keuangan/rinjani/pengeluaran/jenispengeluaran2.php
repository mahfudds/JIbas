...
require_once('jenispengeluaran2.func.php');
...
<head>
    ...
    <script language="javascript" src="jenispengeluaran2.js?r=<?=filemtime('jenispengeluaran2.js')?>"></script>
</head>
    ...
    <tr>
        ...
        <tr>
            <td align="right">
                ...
                <span class="pageTitle">Jenis Pengeluaran</span><br>
                <a class="pageLink" href="pengeluaran.php"><b>Pengeluaran</b></a>&nbsp;&gt;&nbsp;
                <span class="pageLinkCurrent">Jenis Pengeluaran
            </td>
        </tr>
        </table><br />
...
<?php       ShowDaftarJenisPengeluaran($db); ?>
        </div>
