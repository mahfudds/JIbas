...
header('Content-Disposition: attachment; filename=Laporan_tabungan_pegawai.xls');
header('Expires: 0');
...
<center><font size="4" face="Arial"><strong>LAPORAN TABUNGAN PEGAWAI</strong></font><br /></center>
<table border="0">
    <tr>
        <td>Departemen:</td>
        <td><?=$departemen?></td>
