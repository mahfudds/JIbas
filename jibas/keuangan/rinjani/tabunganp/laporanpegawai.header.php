...
require_once('laporanpegawai.header.func.php');
...
<head>
    ...
    <script language="javascript" src="laporanpegawai.header.js?r=<?=filemtime('laporanpegawai.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php           $departemen = RequestData("departemen", "");
                ShowSelectDepartemenTabunganPegawai($db) ?>
            </td>
...
<?php           echo "<input type='text' id='ftanggal1' onclick='showPilihTanggal(1, \"$dt1\")' readonly size='15' value='$fdt1' class='inputbox' style='background-color:#ddd; width: 150px;'>&nbsp;";
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Tabungan Pegawai</span><br>
        <a class="pageLink" href="tabunganp.php" target="_parent"><b>Tabungan Pegawai</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Tabungan Pegawai</td>
    </td>
</tr>
</table>
