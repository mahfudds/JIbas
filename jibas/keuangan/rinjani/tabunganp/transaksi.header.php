...
require_once('transaksi.header.func.php');
...
<head>
    ...
    <script language="javascript" src="transaksi.header.js?r=<?=filemtime('transaksi.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php       $departemen = RequestData("departemen", "");
            ...
            &nbsp;&nbsp;<b>Tahun Buku:</b>&nbsp;
            <span id="spTahunBuku">
<?php       ShowTahunBukuTabunganPegawai($db) ?>
            </span>
        </td>
...
<?php       ShowSelectTabunganPegawai($db);    ?>
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Setoran &amp; Tarikan</span><br>
        <a class="pageLink" href="tabunganp.php"><b>Tabungan Pegawai</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Setoran &amp; Tarikan</td>
    </td>
</tr>
</table>
