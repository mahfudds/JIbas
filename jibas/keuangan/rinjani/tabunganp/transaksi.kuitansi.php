...
$sql = "SELECT p.replid AS id, s.nis, s.nama, j.nokas, 
		  ...
		  FROM jbsfina.tabungan p, jbsfina.jurnal j, jbsakad.siswa s 
            ...
            <tr>
                <td align="left" colspan='2'>
                    ...
                    <tr>
                        <td width="20">&nbsp;</td>
                        <td width="60">
<?php                       if ($_REQUEST["status"] == "calon") echo  "No Pendaftaran"; else echo  "N I S"; ?>
                        </td>
                    ...
                    <td align="center">
<?php                   if ($i == 0) { ?>
                        Yang menerima<br /><br /><br /><br /><br />( <?=getUserName() ?> )
<?php                   } else { ?>
