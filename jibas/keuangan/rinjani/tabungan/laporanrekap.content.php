...
<head>
    ...
    <script language="javascript" src="laporanrekap.content.js?r=<?=filemtime('laporanrekap.content.js')?>"></script>
</head>
...
<input type="hidden" id="datetime1" value="<?= $datetime1 ?>">
<input type="hidden" id="datetime2" value="<?= $datetime2 ?>">
...
echo "<td width='140'>Selisih Saldo</td>";
echo "</tr>";
