...
<head>
    ...
    <title>Saldo Total Tabungan per Lokasi Dana</title>
    ...
    <script language="javascript" src="laporanlokasi.header.js?r=<?=filemtime('laporanlokasi.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php                   $departemen = RequestData("departemen", "");
        ...
        <td align="right" valign="top" width="30%">
            ...
            <span class="pageTitle">Saldo Tabungan per Lokasi Dana</span><br>
            <a class="pageLink" href="<?= $sourcefrom ?>" target="_parent"><?= $from ?></a>&nbsp;&gt;&nbsp;
            <span class="pageLinkCurrent">Saldo Tabungan per Lokasi Dana</td>
        </td>
    </tr>
</table>
