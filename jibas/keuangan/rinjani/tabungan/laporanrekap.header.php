...
require_once('laporankelas.header.func.php');
require_once('laporanrekap.header.func.php');
...
<head>
    ...
    <script language="javascript" src="laporanrekap.header.js?r=<?=filemtime('laporanrekap.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php       $departemen = RequestData("departemen", "");
            ShowSelectDepartemenTabunganSiswa($db) ?>
            &nbsp;&nbsp;
            <b>Petugas:</b>
...
<?php       echo "<input type='text' id='ftanggal1' onclick='showPilihTanggal(1, \"$dt1\")' readonly size='15' value='$fdt1' class='inputbox' style='background-color:#ddd; width: 150px;'>&nbsp;";
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Rekapitulasi Tabungan</span><br>
        <a class="pageLink" href="<?= $sourcefrom ?>" target="_parent"><?= $from ?></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Rekapitulasi Tabungan</td>
    </td>
</tr>
</table>
