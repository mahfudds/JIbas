...
require_once('laporanrekap.detail.func.php');
...
$namapetugas = $_REQUEST['namapetugas'];
...
<head>
    ...
    <script language="javascript" src="laporanrekap.detail.js?r=<?= filemtime('laporanrekap.detail.js') ?>"></script>
</head>
<body style="margin: 10px;">

<center>
    <span class="dialogTitle">Rincian Rekapitulasi Tabungan</span>
</center><br>
...
$select = $jenis == "SETORAN" ? "SUM(t.kredit) AS jumlah" : "SUM(t.debet) AS jumlah";
if ($kelompok == "siswa")
{
    $sql = "SELECT $select, COUNT(t.replid)
...
<?php
    $page = 1;
    ShowRincianRekapitulasiTabungan();
?>
</div>
