...
function ShowRincianSaldoTabunganLokasi()
{
    global $nRowPerPage;
    global $stIdList, $kelompok, $idtabungan, $page, $ndata;
    ...
    try
    {
        ...
        if ($kelompok == "siswa")
        {
            $sql = "SELECT t.nis AS userid, s.nama, t.debet, t.kredit, t.petugas, t.keterangan, t.tanggal
                      FROM jbsfina.tabungan t, jbsakad.siswa s 
                     WHERE t.nis = s.nis
                       AND t.replid IN ($stIdList)";
        }
        else
        {
            $sql = "SELECT t.nip AS userid, p.nama, t.debet, t.kredit, t.petugas, t.keterangan, t.tanggal
        ...
        echo "<td class='header' width='25%' align='center'>Siswa/Pegawai</td>";
        echo "<td class='header' width='20%' align='center'>Setoran</td>";
        echo "<td class='header' width='20%' align='center'>Tarikan</td>";
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "kprjx");
    }
    finally
    {
        $db->Close();
