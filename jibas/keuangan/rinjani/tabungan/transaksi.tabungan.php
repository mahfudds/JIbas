...
<head>
    ...
    <title>Setoran & Tarikan Tabungan Siswa</title>
...
<input type="hidden" id="userid" value="<?=$nis?>">
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <tbody style="display: none">
                <tr>
                    <td width="27%">Tabungan <?= $tag_mandatory ?></td>
                    <td><b><?= $namatabungan ?></b></td>
                </tr>
                <tr>
                    <td>Jumlah <?= $tag_mandatory ?></td>
                    <td>
                        <input type="text" id="jsetor" class="inputbox-money fw-bold" style="width: 200px"
                ...
                <tr>
                    <td>Sumber Dana</td>
                    <td>
<?php                   ShowSelectSumberDanaTabunganSiswa($db) ?>
                    </td>
                </tr>
                <tr>
                    <td>Penyimpanan<br><i><span style="color: #999">(lokasi dana)</span></i></td>
                    <td>
<?php                   ShowSelectLokasiDanaTabunganSiswa($db, 'lokasidanasetor') ?>
                    </td>
                </tr>
                <tr>
        ...
        <td valign="top">
            ...
            <tbody style="display: none">
                ...
                <tr>
                    <td>Jumlah <?= $tag_mandatory ?></td>
                    <td>
                        <input type="text" id="jtarik" class="inputbox-money fw-bold" style="width: 200px"
                               onblur="Rupiah.FormatRupiah('jtarik');" onfocus="Rupiah.UnformatRupiah('jtarik');" >
                    </td>
                </tr>
                <tr>
                    <td>Pengembilan<br><i><span style="color: #999">(lokasi dana)</span></i></td>
                    <td>
                ...
                <tr>
                    <td valign="top" align="left">&nbsp;</td>
                    <td align="left">
                        <input type="button" id="simpantarik" class="dialogButtonOrange" value="TARIK"
