...
<head>
    ...
    <title>Saldo Total Tabungan</title>
    ...
    <script language="javascript" src="laporantotal.header.js?r=<?=filemtime('laporantotal.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php           $departemen = RequestData("departemen", "");
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Saldo Tabungan Terakhir</span><br>
        <a class="pageLink" href="<?= $sourcefrom ?>" target="_parent"><?= $from ?></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Saldo Tabungan Terakhir</td>
    </td>
</tr>
</table>
