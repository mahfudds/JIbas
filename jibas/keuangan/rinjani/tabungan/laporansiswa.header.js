...
function showLaporan()
{
    ...
    parent.content.location.href = "laporansiswa.content.php?" + qsb.createQs();
}
...
function showHelp()
{
    newWindow('../help/ts_lapsiswa.html', 'LaporanTabunganSiswaHelp','620','520','resizable=1,scrollbars=1,status=0,toolbar=0')
}