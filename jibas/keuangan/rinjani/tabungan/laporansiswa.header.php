...
<head>
    ...
    <script language="javascript" src="laporansiswa.header.js?r=<?=filemtime('laporansiswa.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php           echo "<input type='text' id='ftanggal1' onclick='showPilihTanggal(1, \"$dt1\")' readonly size='15' value='$fdt1' class='inputbox' style='background-color:#ddd; width: 150px;'>&nbsp;";
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Tabungan per Siswa</span><br>
        <a class="pageLink" href="tabungan.php" target="_parent"><b>Tabungan Siswa</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Tabungan per Siswa</td>
    </td>
</tr>
</table>
