...
if ($action == "setor")
{
    ...
    echo "<td>";
    ShowSelectSumberDanaTabunganSiswa($db);
    echo "</td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td>Penyimpanan<br><i><span style='color: #999'>(lokasi dana)</span></i></td>";
    echo "<td>";
    ShowSelectLokasiDanaTabunganSiswa($db, 'lokasidana');
    echo "</td>";
    echo "</tr>";
}
else
{
    ...
    ShowSelectLokasiPengambilanTabunganSiswa($db, $nis, $idtabungan, $lokasidana);
    echo "</span>";
    echo "</td>";
    echo "</tr>";
}
