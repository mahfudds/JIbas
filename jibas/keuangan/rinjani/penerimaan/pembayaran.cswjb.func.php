...
function ShowBesarJttCalonInfo($payInfo)
{
...
function ReloadBesarJttCalon()
{
    ...
    try
    {
        ...
        $payInfo = GetPaymentInfoCsWjb($db, $idpenerimaan, $idtahunbuku, $idCalonSiswa);
        ShowBesarJttCalonInfo($payInfo);
    }
    catch (Exception $ex)
    {
...
function ReloadRiwayatPembayaranJttCalon()
{
    $db = new Db();
    try
    {
...
function ShowRiwayatPembayaranJttCalon($db, $payInfo)
{
