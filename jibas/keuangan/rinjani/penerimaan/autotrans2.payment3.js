...
{
    $.ajax({
        url: "../help/pn_batchpayment.html?" + Rnd.String(),
...
change_dep = function ()
{
    ...
    qsb.addInput("selkelompok", "selkelompok");

    document.location.href = "autotrans2.payment.php?" + qsb.createQs();
};

onSelKelompokChange = function ()
{
    change_dep();
};
...
showPaymentSelect = function()
{
    ...
    var lbPengaturan = $("#lbPengaturan");

    divSelect.html("memuat ..");
    divList.html("");
    lbPengaturan.css("visibility", "hidden");

    $.ajax({
        url: "autotrans2.payment.ajax.php",
        ...
        success: function (json)
        {
            ...
            lbPengaturan.css("visibility", "visible");
            divSelect.html(html);
