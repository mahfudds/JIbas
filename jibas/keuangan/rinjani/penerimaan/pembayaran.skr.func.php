 ...
 **[N]**/ ?>
<?php
function GetPaymentInfoSkr($db, $idpenerimaan, $idtahunbuku)
{
    $obj = new stdClass();
...
function ShowRiwayatPembayaranSkr($db, $nis, $idPenerimaan, $idTahunBuku)
{
    try
    {
        ...
        if ($nData == 0)
        {
            ...
            echo "<span class='hide-in-report'>";
        ...
        else
        {
            ...
            echo "<a href='#' onClick='reloadRiwayatSkr()'><img src='../images/ico/refresh.png' title='refresh' border='0'/>&nbsp;refresh</a>&nbsp;&nbsp;";
