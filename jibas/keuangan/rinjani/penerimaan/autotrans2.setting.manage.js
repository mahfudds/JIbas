...
tambahPenerimaan = function ()
{
    ...
    var addr = "autotrans2.setting.penerimaan.php?departemen=" + dept + "&idautotrans=0&kelompok=" + kelompok;
...
acceptPenerimaan = function(idPenerimaan, penerimaan, besar, urutan, keterangan)
{
    ...
    var ix = lsLen - 1;
    var table = "<tr id='tabDaftarRow-" + ix + "' style='height: 30px'>";
    table += "<td align='center' class='numberColumn'>" + lsLen + "</td>";
