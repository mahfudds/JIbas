...
function showLaporan()
{
    ...
    parent.content.location.href = "bayarsiswa.content.php?" + qsb.createQs();
}

function showHelp()
{
    newWindow('../../help/pn_bayarsiswa.html', 'BayarSiswaHelp','620','520','resizable=1,scrollbars=1,status=0,toolbar=0'		)
}
