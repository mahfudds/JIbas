...
if ($idkategori == "JTT")
{
    $sql = "SELECT p.tanggal, p.jumlah, p.info1 AS diskon, p.keterangan, 
                   IF(j.idpetugas IS NULL, 'admin', j.idpetugas) AS idpetugas, j.transaksi, p.jam
...
{
    $sql = "SELECT p.tanggal, p.jumlah, 0 AS diskon, p.keterangan, 
                   IF(j.idpetugas IS NULL, 'admin', j.idpetugas) AS idpetugas, j.transaksi, p.jam
...
//echo $sql;
?>
<table id="table" border='1' cellpadding='2' cellspacing='0' width='99%' class="tab" style='border-width: 1px; border-collapse: collapse;'>
    <tr height='25'>
    ...
    ?>
    <tr height='25' >
        <td colspan='3' style='background-color: #ddd' align='right'><strong>TOTAL</strong></td>
        <td align='right' style='background-color: #ddd' ><strong><?=FormatRupiah($totalj)?></strong></td>
        <td align='right' style='background-color: #ddd' ><strong><?=FormatRupiah($totald)?></strong></td>
        <td align='center' style='color: blue; font-size: 14px; background-color: #ddd'><strong><?=FormatRupiah($totalj - $totald)?></strong></td>
    </tr>
</table>
