...
function onChangePage()
{
    ...
    document.location.href = "bayarsiswa.kelas.skr.php?" + qsb.createQs();
}
...
function cetak()
{
    ...
    newWindow('bayarsiswa.kelas.skr.cetak.php?'+qsb.createQs(), 'CetakBayarSiswaKelasSkr','1000','630','resizable=1,scrollbars=1,status=0,toolbar=0'		)
}
...
function excel()
{
    ...
    newWindow('bayarsiswa.kelas.skr.excel.php?'+qsb.createQs(), 'ExcelBayarSiswaKelasSkr','1000','630','resizable=1,scrollbars=1,status=0,toolbar=0'		)
}
