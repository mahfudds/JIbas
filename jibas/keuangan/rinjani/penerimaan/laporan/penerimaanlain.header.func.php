 ...
 **[N]**/ ?>
<?php
function ShowSelectDepartemenPenerimaanLain($db)
{
    global $departemen;
...
function ShowSelectPenerimaanLain($db)
{
    global $departemen;
    ...
    echo "<select id='penerimaan' style='width:180px' class='inputbox' onchange='showBlankPage();'>";
