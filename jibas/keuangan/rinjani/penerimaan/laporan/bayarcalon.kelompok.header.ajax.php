...
if ($op == "fetchproses")
{
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "kxqk8");
    }
    finally
    {
        $db->Close();
...
else if ($op == "fetchkelompok")
{
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "k24k3");
    }
    finally
    {
        $db->Close();
...
else if ($op == "fetchpenerimaan")
{
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "kjgkf");
    }
    finally
    {
        $db->Close();
