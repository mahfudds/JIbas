...
require_once('rekap.pembayaran.header.func.php');
...
<head>
    ...
    <script language="javascript" src="rekap.pembayaran.header.js?r=<?=filemtime('rekap.pembayaran.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php
            ...
            ShowSelectDepartemenRekapPenerimaan($db)
?>
            &nbsp;&nbsp;<strong>Jenis:</strong>&nbsp;&nbsp;
<?php
            ShowSelectKategoriRekapPenerimaan($db);
?>
        </td>
    ...
    <tr>
        <td><b>Laporan:</b></td>
        <td>
            <select id="laporan" style="width:150px;" class="inputbox" onchange="onSelectionChange()" >
                <option value="1">Rekapitulasi Total</option>
                <option value="2">Rekapitulasi Harian</option>
            </select>
            &nbsp;&nbsp;<strong>Petugas:</strong>&nbsp;&nbsp;
<?php
            ShowSelectPetugasRekapPenerimaan($db);
?>
        </td>
    </tr>
    </table>
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Rekapitulasi Penerimaan</span><br>
        <a class="pageLink" href="../penerimaan.php" target="_parent"><b>Penerimaan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Rekapitulasi Penerimaan</td>
    </td>
</tr>
</table>
