...
if ($idkategori == "JTT")
{
    $sql = "SELECT p.tanggal, p.jumlah, p.info1 AS diskon, p.keterangan, IF(j.idpetugas IS NULL, 'admin', j.idpetugas) AS idpetugas, j.transaksi, p.jam
...
{
    $sql = "SELECT p.tanggal, p.jumlah, 0 AS diskon, p.keterangan, IF(j.idpetugas IS NULL, 'admin', j.idpetugas) AS idpetugas, j.transaksi, p.jam
...
//echo $sql;
?>
<table border='1' class="tab" id="table" cellpadding='2' cellspacing='0' width='99%' style='border-width: 1px; border-collapse: collapse;'>
    <tr height='25'>
    ...
    while($row = mysqli_fetch_array($res))
    {
        ...
        <tr height='22'>
            ...
            <td align='center'><?=RegularDateFormat($row['tanggal']) . "<br>" . $row['jam'] ?></td>
    ...
    <tr height='25' style='background-color: #ddd'>
        <td colspan='3' align='right' class="footerColumn"><strong>TOTAL</strong></td>
        <td align='right' class="footerColumn"><strong><?=FormatRupiah($totalj)?></strong></td>
        <td align='right' class="footerColumn"><strong><?=FormatRupiah($totald)?></strong></td>
        <td align='center'  class="footerColumn" style='color: maroon; font-size: 12px;'><strong><?=FormatRupiah($totalj - $totald)?></strong></td>
    </tr>
</table>
