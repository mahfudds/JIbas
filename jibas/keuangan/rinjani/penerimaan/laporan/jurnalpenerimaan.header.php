...
require_once('jurnalpenerimaan.header.func.php');
...
<head>
    ...
    <title>Laporan Jurnal Penerimaan</title>
    ...
    <script language="javascript" src="jurnalpenerimaan.header.js?r=<?=filemtime('jurnalpenerimaan.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<?php
            ...
            ShowSelectDepartemenJurnalPenerimaan($db)
?>
            &nbsp;&nbsp;<strong>Tahun Buku:</strong>&nbsp;
            <span id="spTahunBuku">
<?php
            ShowSelectTahunBukuJurnalPenerimaan($db)
?>
            </span>
        </td>
    ...
    <tr>
        ...
        <td>
<?php
        ShowSelectKategoriJurnalPenerimaan($db);
?>
        </td>
    </tr>
    <tr>
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Jurnal Penerimaan</span><br>
        <a class="pageLink" href="../penerimaan.php" target="_parent"><b>Penerimaan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Jurnal Penerimaan</td>
    </td>
</tr>
</table>
