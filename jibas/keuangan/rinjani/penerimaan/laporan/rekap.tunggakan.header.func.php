 ...
 **[N]**/ ?>
<?php
function ShowSelectDepartemenRekapTunggakan($db)
{
    global $departemen;
...
function ShowSelectTingkatRekapTunggakan($db)
{
...
function ShowSelectKelasRekapTunggakan($db)
{
...
function ShowSelectTahunBukuRekapTunggakan($db)
{
    global $departemen;
