...
<head>
    ...
    <script language="javascript" src="bayarcalon.header.js?r=<?=filemtime('bayarcalon.header.js')?>"></script>
</head>
<body style="margin: 0">
...
<tr>
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Pembayaran Calon Siswa</span><br>
        <a class="pageLink" href="../penerimaan.php" target="_parent"><b>Penerimaan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Pembayaran Calon Siswa</td>
    </td>
</tr>
</table>
