...
function showLaporan()
{
    ...
    parent.content.location.href = "bayarcalon.content.php?" + qsb.createQs();
}

function showHelp()
{
    newWindow('../../help/pn_bayarcalon.html', 'BayarCalonHelp','620','520','resizable=1,scrollbars=1,status=0,toolbar=0'		)
}