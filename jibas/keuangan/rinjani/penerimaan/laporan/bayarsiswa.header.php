...
<head>
    ...
    <script language="javascript" src="bayarsiswa.header.js?r=<?=filemtime('bayarsiswa.header.js')?>"></script>
</head>
...
?>
    ...
    <td align="right" valign="top" width="30%">
        ...
        <span class="pageTitle">Pembayaran Siswa</span><br>
        <a class="pageLink" href="../penerimaan.php" target="_parent"><b>Penerimaan</b></a>&nbsp;&gt;&nbsp;
        <span class="pageLinkCurrent">Pembayaran Siswa</td>
    </td>
</tr>
</table>
