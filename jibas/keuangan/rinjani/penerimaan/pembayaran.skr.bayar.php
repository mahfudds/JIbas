...
require_once('pembayaran.skr.bayar.func.php');
...
<head>
    ...
    <script language="javascript" src="pembayaran.skr.bayar.js?r=<?= filemtime('pembayaran.skr.bayar.js') ?>"></script>
</head>
...
<tr>
    ...
    <td width="500">
        <input id="jumlah" type="text" class="inputbox-money bg-light-blue fw-bold" style="width: 250px"
...
<tr>
    <td colspan="2" align="center">
        <br>
        <input type="button" id="btSimpan" class="dialogButtonPositive" value="Simpan" onclick="simpanBayarSkr()">
