...
<head>
    ...
    <script language="javascript" src="jenispenerimaan2.js?r=<?=filemtime('jenispenerimaan2.js')?>"></script>
</head>
    ...
    <tr>
        ...
        <tr>
            <td align="right">
                ...
                <span class="pageTitle">Jenis Penerimaan</span><br>
                <a class="pageLink" href="penerimaan.php"><b>Penerimaan</b></a>&nbsp;&gt;&nbsp;
                <span class="pageLinkCurrent">Jenis Penerimaan
            </td>
        </tr>
        </table><br>
        ...
        <tr>
            ...
            <td width="200">
                ...
                ShowSelectDepartemenPenerimaan($db);
                ?>
            </td>
            <td width="100" align="right"><strong>Kategori&nbsp;</strong></td>
            <td width="200">
<?php
            $idKategori = isset($_REQUEST["idkategori"]) ? $_REQUEST["idkategori"] : "";
            ShowSelectKategoriPenerimaan($db);
?>
            </td>
