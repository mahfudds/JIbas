...
function ShowSelectPayment($jenis, $dept)
{
    ...
    echo "<span style='display:inline-block; width: 85px'>Pembayaran:</span><select name='payment' id='payment'  class='inputbox' style='width: 250px'  onchange='ChangePayment()' onkeyup='ChangePayment()'>\r\n";
