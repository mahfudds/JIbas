...
PrintDetail = function()
{
	...
	var addr = "multitrans2.content.print.detail.php?departemen="+dept+"&jenis="+jenis+"&noid="+noid+"&jumlah="+jumlah+"&ktransaksi="+ktransaksi;
...
PrintCompact = function()
{
	...
	var addr = "multitrans2.content.print.compact.php?departemen="+dept+"&jenis="+jenis+"&noid="+noid+"&jumlah="+jumlah+"&ktransaksi="+ktransaksi+"&paymentlist="+paymentlist;
