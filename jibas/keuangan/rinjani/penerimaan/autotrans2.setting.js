...
{
    $.ajax({
        url: "../help/pn_pengaturanbatch.html?" + Rnd.String(),
...
tambahAutoTrans = function ()
{
    ...
    var addr = "autotrans2.setting.manage.php?departemen=" + dept + "&idautotrans=0";
...
setAktif = function (no, idAutoTrans)
{
    ...
    $.ajax({
        url: "autotrans2.setting.ajax.php",
...
{
    var dept = $("#departemen").val();
    var addr = "autotrans2.setting.manage.php?departemen=" + dept + "&idautotrans=" + idAutoTrans;
    newWindow(addr, 'AutoTransManage','790','630','resizable=1,scrollbars=1,status=0,toolbar=0');
};
