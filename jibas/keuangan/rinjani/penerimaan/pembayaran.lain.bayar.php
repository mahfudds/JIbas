...
require_once('pembayaran.lain.bayar.func.php');
...
<head>
    ...
    <script language="javascript" src="pembayaran.lain.bayar.js?r=<?= filemtime('pembayaran.lain.bayar.js') ?>"></script>
</head>
...
<tr>
    <td width="150">Penerimaan</td>
    <td width="500"><b><?=$penerimaan?></b></td>
</tr>
<tr>
...
<tr>
    <td>Identitas<?=$tag_mandatory?></td>
    <td>
        <input id="sumber" type="text" class="inputbox-money bg-light-blue" style="width: 250px"
               value="<?= $sumber ?>">
    </td>
</tr>
<tr>
...
<tr>
    <td colspan="2" align="center">
        <br>
        <input type="button" id="btSimpan" class="dialogButtonPositive" value="Simpan" onclick="simpanBayarLain()">
