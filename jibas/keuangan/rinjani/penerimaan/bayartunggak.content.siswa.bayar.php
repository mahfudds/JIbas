...
require_once('bayartunggak.content.siswa.bayar.func.php');
...
<head>
    ...
    <script language="javascript" src="bayartunggak.content.siswa.bayar.js?r=<?= filemtime('bayartunggak.content.siswa.bayar.js') ?>"></script>
</head>
