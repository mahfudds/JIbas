...
echo "<table id='tabReport' class='tab' border='1' cellpadding='5' cellspacing='0'>";
...
for($i = 0; $i < count($lsTanggal); $i++)
{
    ...
    for($j = 0; $j < count($lsPembayaran); $j++)
    {
        ...
        else
        {
            ...
            echo "<a onclick='showRekapDetail2(\"$stIdPgTrans\",\"$jsonPen\",\"$jsonTgl\")' style='cursor: pointer; color: #0000ff; font-weight: normal; text-decoration: none'>$rp</a>";
        }
        echo "</td>";
    }
    ...
    else
    {
        ...
        echo "<a onclick='showRekapDetail2(\"$stIdPgTrans\",\"$jsonPen\",\"$jsonTgl\")' style='cursor: pointer; color: #0000ff; font-weight: bold; text-decoration: none'>$rp</a>";
    }
    echo "</td>";
    echo "</tr>";
