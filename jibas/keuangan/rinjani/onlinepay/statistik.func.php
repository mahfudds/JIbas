...
function ShowSelectDepartemen()
{
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "kgbj6");
    }
    finally
    {
        $db->Close();
...
function ShowSelectBank()
{
    ...
    try
    {
        ...
        $sql = "SELECT bankno, bank, bankname
                  FROM jbsfina.bank2
                 WHERE aktif = 1
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "ka9ke");
    }
    finally
    {
        $db->Close();
...
function ShowSelectPetugas()
{
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "ktk5q");
    }
    finally
    {
        $db->Close();
...
function StatistikPembayaranHarian()
{
    ...
    try
    {
        ...
        for($i = 0; $i < count($lsTanggal); $i++)
        {
            ...
            echo "<td align='right'><span class='fst_currency fst_bold' style='font-size: 16px;'>$rp</span></td>";
            echo "<td align='center' class='rincian'>";
            echo "<a href='#' style='font-weight: normal; text-decoration: underline; color: blue;' onclick=\"showRincianHarian('$tanggal','$departemen','$bankNo','$bankName','$idPetugas','$metode')\">rincian</a>";
            echo "</td>";
            echo "</tr>";
        }
        ...
        $rp = FormatRupiah($sumTransaksi);
        echo "<td align='right' style='background-color: #ffc038;'><span class='fst_currency fst_big fst_bold' style='font-size: 18px;'>$rp</span></td>";
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "k5ecs");
    }
    finally
    {
        $db->Close();
...
function StatistikPembayaranBulanan()
{
    ...
    try
    {
        ...
        for($i = 0; $i < count($lsBulan); $i++)
        {
            ...
            echo "<td align='center'><span style='font-size: 16px;'>$nTransaksi</span></td>";
            $rp = FormatRupiah($sumTransaksi);
            echo "<td align='right'><span class='fst_currency' style='font-size: 16px;'>$rp</span></td>";
            echo "<td align='center' class='rincian'>";
            echo "<a href='#' style='font-weight: normal; text-decoration: underline; color: blue;' onclick=\"showRincianBulanan('$bulan','$tahun','$departemen','$bankNo','$bankName','$idPetugas','$metode')\">rincian</a>";
            echo "</td>";
            echo "</tr>";
        }
        ...
        echo "<td align='center' style='background-color: #ffc038;'><span style='font-size: 16px; font-weight: bold;'>$nTransaksi</span></td>";
        $rp = FormatRupiah($sumTransaksi);
        echo "<td align='right' style='background-color: #ffc038;'><span class='fst_currency' style='font-size: 16px; font-weight: bold;'>$rp</span></td>";
        echo "<td align='right' class='rincian' style='background-color: #ffc038;'>&nbsp;</td>";
        echo "</tr>";
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "k7kk5");
    }
    finally
    {
        $db->Close();
