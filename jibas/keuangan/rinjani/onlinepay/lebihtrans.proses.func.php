...
function SimpanTransferBalik()
{
    ...
    try
    {
        ...
        $sql = "SELECT p.metode, p.nomor, p.jlebihtrans, p.jlebihsisa, p.bankno, b.departemen, b.rekkas, b.rekpendapatan, b.aktif
                  FROM jbsfina.pgtranslebih2 p, jbsfina.bank2 b
        ...
        $idJurnal = OnlinePay_SimpanJurnal($db, $idTahunBuku, $tanggal, $transaksi, $noKasBank, $keterangan, $idPetugas, $petugas, "lebihtransferrefund");
        OnlinePay_SimpanDetailJurnal($db, $idJurnal, "K", $rekKasBank, $jLebih);
        OnlinePay_SimpanDetailJurnal($db, $idJurnal, "D", $rekPendapatanBank, $jLebih);
        ...
        $sql = "UPDATE jbsfina.pgtranslebih2
...
*/
    ...
    try
    {
        ...
        $idJurnal = OnlinePay_SimpanJurnal($db, $idTahunBuku, $tanggal, $transaksi, $noKasBank, $keterangan, $idPetugas, $petugas, "lebihtransfertab");
        OnlinePay_SimpanDetailJurnal($db, $idJurnal, "K", $rekKasBank, $jLebih);
        OnlinePay_SimpanDetailJurnal($db, $idJurnal, "D", $rekPendapatanBank, $jLebih);
        ...
        $idJurnal = OnlinePay_SimpanJurnal($db, $idTahunBuku, $tanggal, $transaksi, $noKasTab, "", $idPetugas, $petugas, "setorantabungan");
        OnlinePay_SimpanDetailJurnal($db, $idJurnal, "D", $rekKasTab, $jLebih);
        OnlinePay_SimpanDetailJurnal($db, $idJurnal, "K", $rekUtangTab, $jLebih);
