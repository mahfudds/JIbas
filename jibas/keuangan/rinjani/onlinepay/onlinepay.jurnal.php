 ...
 **[N]**/ ?>
<?php
function OnlinePay_SimpanJurnal($db, $idtahunbuku, $tanggal, $transaksi, $nokas, $keterangan, $idpetugas, $petugas, $sumber)
{
...
function OnlinePay_SimpanDetailJurnal($db, $idjurnal, $align, $koderek, $jumlah)
{
    if ($align == "D")
