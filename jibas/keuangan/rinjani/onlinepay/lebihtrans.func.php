...
function ShowLebihTransSudah()
{
    ...
    try
    {
        ...
        $sql = "SELECT p.id, DATE_FORMAT(p.waktu, '%d %b %Y<br>%H:%i') AS fwaktu, p.metode, p.nomor, p.jlebihtrans, p.jlebihsisa, p.bankno, b.bank, 
                  ...
                  FROM jbsfina.pgtranslebih2 p
                 INNER JOIN jbsfina.pgtrans2 pgt ON p.nomor = pgt.nomor
                 INNER JOIN jbsfina.bank2 b ON p.bankno = b.bankno
                  LEFT JOIN jbsfina.bankmutasi2 bm ON p.pridmutasi = bm.replid
        ...
        echo "<table id='tabLebihTrans' cellpadding='5' cellspacing='0' class='tab'>";
        ...
        echo "<td class='header' width='250' align='center'>Nomor/Bank</td>";
        echo "</tr>";
        ...
        while($row = mysqli_fetch_array($res))
        {
            ...
            echo "<td align='left'><b>$row[namasiswa]</b><br>";
            ...
            echo "<td align='right'><span class='fst_currency fsz_14 fst_bold'>$rp</span></td>";
