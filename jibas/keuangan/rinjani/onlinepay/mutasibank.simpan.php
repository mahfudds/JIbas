...
<table id="tabMutasiSimpan" class="tab" cellpadding="5" cellspacing="0">
...
<br>
<input type="button" id="btMutasiSimpan" class="dialogButtonPositive" style="width: 150px; height: 40px;" value="Simpan Dana di Bank" onclick="simpanMutasiSimpan()">
