...
<?php       ShowSelectDepartemen('deptnomor'); ?>
        </td>
    </tr>
    <tr>
        ...
        <td align="left" valign="middle">
            ...
            <input type="button" class="dialogButtonGray" value="cari" style="width: 50px; height: 23px;" onclick="SearchTagihan()">
...
function ShowSelectDepartemen($elementId = 'departemen')
{
    global $departemen;
    ...
    try
    {
        ...
        echo "<select id='$elementId' class='inputbox' name='$elementId' style='width: 250px' onchange='changeDep()'>";
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "kcdub");
    }
    finally
    {
        $db->Close();
...
function ShowSearchSiswa()
{
    ...
    <tr>
        <td align="left" valign="middle">Departemen:</td>
        <td align="left" valign="middle">
<?php       ShowSelectDepartemen('deptsiswa'); ?>
        </td>
    </tr>
    <tr>
        ...
        <td align="left" valign="middle">
            ...
            <input type="button" class="dialogButtonGray" value="cari siswa" style="width: 70px; height: 25px;" onclick="SearchUser()">
...
function ShowTagihanSiswa($nis, $nama, $bulan, $tahun)
{
    ...
    try
    {
        ...
        while($row = mysqli_fetch_array($res))
        {
            ...
            echo "<span class='fst_currency fst_bold fsz_16'>" . FormatRupiah($jumlah) . "</span><br>";
            echo "<b>" . $row["info"] . "</b><br>";
            echo "<span class='bs_secondary fst_italic'>$noTagihan</span>" ;
            echo "</td>";
            echo "</tr>";
        }
        echo "</table><br>";
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "kvx26");
    }
    finally
    {
        $db->Close();
...
function SearchTagihan()
{
    ...
    try
    {
        ...
        $sql = "SELECT t.replid, t.info, t.jumlah, t.status, t.nis, s.nama,
                       t.notagihan, DATE_FORMAT(t.ckdate, '&d-%b-%Y') AS fdate, IFNULL(t.ckdesc, '') AS ckdesc
                  FROM jbsfina.tagihansiswainfo2 t, jbsfina.tagihanset2 ts, jbsakad.siswa s
    ...
    {
        echo Msg::InfoError($ex->getMessage(), "k0crt");
    }
    finally
    {
        $db->Close();
