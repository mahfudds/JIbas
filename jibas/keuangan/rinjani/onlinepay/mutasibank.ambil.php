...
<table id="tabMutasiAmbilRincian" class='tab' cellpadding="5" cellspacing="0">
...
<div>
    ...
    <input type="button" id="btMutasiAmbil" class="dialogButtonPositive" style="width: 180px; height: 40px;" value="Ambil Dana dari Bank" onclick="simpanMutasiAmbil()">
    <span id="spInfo"></span>
</div>
