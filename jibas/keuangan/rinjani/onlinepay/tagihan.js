...
fetchIuran = function (dept)
{
    ...
    $.ajax({
        ...
        success: function (data)
        {
            $("#diviuran").html(data).hide().fadeIn(500);
        },
        error: function(xhr)
        {
            alert(xhr.responseText);
...
fetchKelas = function (dept, idTingkat)
{
    ...
    $.ajax({
        ...
        success: function (data)
        {
            $("#divkelas").html(data).hide().fadeIn(500);
        },
        error: function(xhr)
        {
            alert(xhr.responseText);
...
createInvoice = function ()
{
    ...
    $.ajax({
        ...
        success: function (json)
        {
            ...
            if (result[0] === 1)
                showToast(result[1], 2000, 'success', 'bottom');
            else
                showToast(result[1], 2000, 'error', 'bottom');
        },
        error: function(xhr)
        {
            alert(xhr.responseText);
...
function showTagihanKelasHelp()
{
     $.ajax({
        url: "../help/op_tagihankelas.html?r=" + Math.random(),
