...
DialogBox.prototype.showImage = function(image, content, method)
{
    if (this.dialogBox === undefined)
        return;
    ...
    var divContent = "<div style='display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center'>";
    divContent += "<img src='" + image + "'><br>";
    divContent += "<p>" + content + "</p>";
    divContent += "</div>";

    $(this.divElement).html(divContent);
    //this.dialog_Instance.dialog("open");
    this.dialogBox.dialog("open");
...
{
    var content = "<font style='color: #BB3D20; font-weight: bold;'>KESALAHAN</font><br>";
