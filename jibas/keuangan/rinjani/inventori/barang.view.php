...
{
    echo "Tidak ditemukan data barang!";
    exit();
}
...
<tr>
    <td>Harga Satuan</td>
    <td><?= FormatRupiah($row["info1"]) ?></td>
</tr>
<tr>
    <td>Total Harga</td>
    <td>
<?php   $total = $row["jumlah"] * $row["info1"];
...
<tr>
    ...
    <td>
        <?= LongDateFormat($row["tglperolehan"]) ?>
    </td>
</tr>
<tr>
    <td>Kondisi</td>
